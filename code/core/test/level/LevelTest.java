...
public class LevelTest {
    ...
    public void setup() {
        ...
        for (int x = 0; x < 3; x++)
            for (int y = 0; y < 3; y++) {
                if (x < 2) layout[y][x] = new Tile("", new Coordinate(x, y), LevelElement.FLOOR);
                else layout[y][x] = new Tile("", new Coordinate(x, y), LevelElement.WALL);
            }
    ...
    public void test_findPath_onlyOnePathPossible() {
        ...
        for (int x = 0; x < 3; x++)
            for (int y = 0; y < 3; y++)
                layout[y][x] = new Tile("", new Coordinate(x, y), LevelElement.FLOOR);
        layout[1][1] = new Tile("", new Coordinate(1, 1), LevelElement.WALL);
        layout[0][1] = new Tile("", new Coordinate(0, 1), LevelElement.WALL);
        level = new Level(layout);
