...
public class TileTest {
    ...
    public void test_isAccessible() {
        ...
        Tile wall = new Tile("", dummyCoordinate, LevelElement.WALL);
    ...
    public void test_directionTo() {
        Tile north = new Tile("", new Coordinate(0, 1), LevelElement.FLOOR);
        Tile south = new Tile("", new Coordinate(0, -1), LevelElement.FLOOR);
        Tile east = new Tile("", new Coordinate(1, 0), LevelElement.FLOOR);
        Tile west = new Tile("", new Coordinate(-1, 0), LevelElement.FLOOR);
        Tile northEast = new Tile("", new Coordinate(1, 1), LevelElement.FLOOR);
        Tile northWest = new Tile("", new Coordinate(-1, 1), LevelElement.FLOOR);
        Tile southEast = new Tile("", new Coordinate(1, -1), LevelElement.FLOOR);
        Tile southWest = new Tile("", new Coordinate(-1, -1), LevelElement.FLOOR);
